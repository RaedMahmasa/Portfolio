...
function cleanForm()
 {
    form.reset();
    setShowMessage(true)
    setTimeout(() => setShowMessage(flase), 200)
 }
const submit = () => {
...
>
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsum libero consectetur
                 possimus totam deserunt odit aliquam blanditiis suscipit placeat harum velit eligendi aut,
                  explicabo eveniet, vero accusantium neque quasi. Sed!
                </p>
            </div>
            <div class="flex flex-col lg:flex-row lg:gap-x-8">
                <div class="flex flex-1 flex-col items-start space-y-8 mb-12 lg:mb-0 lg:pt-2">
                    <div class="flex flex-col lg:flex-row gap-x-4">
                        <div class="text-accent rounded-sm w-14 h-14
                    flex items-start
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                        ...
                        <div>
                            ...
                            <P class="mb-1 text-paragraph">Aleppo-Syria</P>
                    ...
                    flex items-start
                     ...
                     <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                        ...
                        <div>
                            ...
                            <P class="text-accent font-normal">Email me at raed.raed.mahmasa@gmail.com</P>
                        </div>
                    </div>
                </div>
